	...
	*/
	...
	while (!sair)
	{
		...
		else
		{
			...
			cout << "<DIGITE TRECEIRO NUMERO DO CODIGO NO TERMINAL> ";
			cin >> codigo;
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	//(IF) Testa se o Codigo digitado pelo usuario é verdade, se sim executa o bloco de comandos detro dele, se não (ELSE) executas os comando do comando else sem testa parametro 
